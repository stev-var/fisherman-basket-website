...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* Floating elements */}
      <div
        className="absolute top-1/4 left-10 w-20 h-20 rounded-full bg-seafoam/20 animate-float"
        style={{ animationDelay: "0s" }}
      />
      <div
        className="absolute top-1/3 right-20 w-16 h-16 rounded-full bg-seafoam/30 animate-float"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-1/4 left-1/4 w-12 h-12 rounded-full bg-primary-foreground/10 animate-float"
      ...
      <div className=" z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main heading */}
          <h1
            className="font-serif text-4xl md:text-5xl lg:text-7xl font-bold text-primary-foreground mb-6 animate-fade-in"
          ...
          {/* Subheading */}
          <p
            className="text-xl md:text-2xl lg:text-3xl text-primary-foreground/90 mb-4 font-light animate-fade-in"
          ...
          {/* Description */}
          <p
            className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto animate-fade-in"
            style={{ animationDelay: "0.3s" }}
          >
            Order during the week, and we'll deliver the freshest catch from the
            harbour straight to your doorstep every Sunday morning.
          </p>
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-2 border-primary-foreground/50 text-primary-foreground bg-primary-foreground/10 text-lg px-8 py-6 rounded-full"
              onClick={() =>
                document
                  .querySelector("#fish-menu")
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <ArrowDown className="w-8 h-8 text-black-400" />
        </div>
      </div>
