          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-card p-6 rounded-xl shadow-xl border border-border max-w-xs hidden md:block">
                ...
                <p className="text-muted-foreground text-sm">
                  Serving fresh fish to happy families
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                isherman Basket was born from a simple idea: bring the freshest
                fish from Kerala's harbours directly to families in
                Kanjirappally and Mundakayam, without the hassle of early
                morning market trips.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                Every week, our customers place their orders online. Come Sunday
                morning, we're at the harbour before sunrise, hand-selecting the
                finest catch. By mid-morning, the fish is cleaned, packed, and
                on its way to your home – fresher than any supermarket could
                ever offer.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                We believe in quality over quantity. That's why we only deliver
                on Sundays – to ensure every piece of fish we sell is purchased
                and delivered on the same day, maintaining the highest standards
                of freshness.
              </p>
