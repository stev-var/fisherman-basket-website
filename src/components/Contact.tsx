          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {contactInfo.map((info) => (
                ...
                >
                  <div
                    className={`w-14 h-14 ${info.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform`}
                  >
            ...
            <div className="gradient-ocean rounded-2xl p-8 md:p-10 text-primary-foreground relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-primary-foreground/90 mb-6">
                  Click the button below to place your order on WhatsApp. Just
                  tell us what fish you want and your address – we'll handle the
                  rest!
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-primary-foreground/80">
                        Chotty, Kanjirappally, Mundakayam and Ponkunnam Kottayam
                        District, Kerala
                      </p>
                    </div>
                  </div>
