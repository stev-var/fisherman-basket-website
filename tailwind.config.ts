  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        ocean: { DEFAULT: "hsl(var(--ocean))", light: "hsl(var(--ocean-light))", dark: "hsl(var(--ocean-dark))" },
        seafoam: { DEFAULT: "hsl(var(--seafoam))", light: "hsl(var(--seafoam-light))" },
        sand: "hsl(var(--sand))", coral: "hsl(var(--coral))",
      ...
      animation: { "accordion-down": "accordion-down 0.2s ease-out", "accordion-up": "accordion-up 0.2s ease-out", "fade-in": "fade-in 0.6s ease-out forwards" },
    },
  },
